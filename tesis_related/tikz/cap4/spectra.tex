...
% body of the graph
				...
				\draw [purple, thick, rounded corners] (\i+0.1,4) -- (\i+0.2,4.5) --(\i+0.2+0.1,5) --
				(\i+0.8-0.1,5) --	(\i+0.8,4.5) -- (\i+1-0.1,4);
				\foreach \i in {1,2,3,4}
				\draw [purple, thick, rounded corners] (\i-0.3,2) -- (\i,2.7) -- (\i+0.2-0.1,3) --
				(\i+0.8+0.1,3) --	(\i+1,2.7) -- (\i+1+0.3,2);
				\foreach \i in {1,2,3,4}
				\draw [purple, thick, rounded corners] (\i-0.7,0) -- (\i+0.1,0.9) --
				(\i+0.3,1) -- (\i+0.7,1) --	(\i+0.9,0.9) -- (\i+1.3+0.4,0);
% draw axis
