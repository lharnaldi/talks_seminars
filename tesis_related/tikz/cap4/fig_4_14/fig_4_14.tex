...
%\draw[help lines,step=0.5cm] (-1,-8) grid (24,20); 
				\draw [align=center,name=cfilt] (2.3,0) rectangle (10.3,8);
				\draw [align=center,name=fir1,dashed] (3.5,4.2) rectangle (7.5,7.3);
				\draw [align=center,name=fir2,dashed] (3.5,0.7) rectangle (7.5,3.8);
				...
				\draw node at (5.5,6.5) [scale=1]{$H_I(z)$};
				\draw node at (5.5,5) [scale=1]{$H_I(z)$};
				\draw node at (5.5,3) [scale=1]{$H_Q(z)$};
				\draw node at (5.5,1.5) [scale=1]{$H_Q(z)$};
				%sumas
				...
				\draw node at (1.5,6.5)[name=ine01]{\Large \textopenbullet};
				\draw node at (1.5,1.5)[name=ine02]{\Large \textopenbullet};
				...
				\node [left,scale=1.7] at (1.5,6.5) {$I$};
				\node [right,scale=1.7] at (11,6.5) {$I$};
				\node [left,scale=1.7] at (1.5,1.5) {$Q$};
				\node [right,scale=1.7] at (11,1.5) {$Q$};
				\node [above,scale=1.3] at (8.3,6.5) {$+$};
				\node [below,scale=1.3] at (8.6,6.2) {$-$};
				\node [above,scale=1.3] at (8.3,1.5) {$+$};
				\node [below,scale=1.3] at (9.3,2.4) {$+$};
				%nodos
				\node at (5,7.6) [scale=1] {\textbf{FIR Compiler I}};
				\node at (5,0.4) [scale=1] {\textbf{FIR Compiler Q}};
