...
\begin{tikzpicture}
	...
	\matrix (m1) [row sep=3mm, column sep=5mm]
	{
		...
		\node[dspsquare,minimum width=2.6cm](m003) {$\bar{p}_0(m)W_M^{k_0mM}$}; &
		\node[coordinate]                  (m004) {};    &
		\node[coordinate]                  (m005) {};          &
		\node[coordinate]                  (m006) {};          &
		\node[coordinate]                  (m007) {};          &
...
%		\node[dspnodeopen,dsp/label=above] (m09) {$y_\rho(m)$};  \\
		...
		\node[dspsquare,minimum width=2.6cm](m103) {$\bar{p}_1(m)W_M^{k_0mM}$}; &
		\node[coordinate]                  (m104) {};    &
		\node[coordinate]                  (m105) {};          &
		\node[coordinate]                  (m106) {};          &
		\node[coordinate]                  (m107) {};          &
...
%		%------------------------------------------------------------
		...
		\node[dspsquare,minimum width=2.6cm](m203) {$\bar{p}_\rho(m)W_M^{k_0mM}$}; &
		\node[coordinate]                  (m204) {};    &
		\node[coordinate]                  (m205) {};          &
		\node[coordinate]                  (m206) {};          &
		\node[coordinate]                  (m207) {};          &
...
%		\node[coordinate]                  (m213) {};          &
		...
		\node[dspsquare,minimum width=2.6cm](m303) {$\bar{p}_{M-1}(m)W_M^{k_0mM}$}; &
		\node[coordinate]                  (m304) {};    &
		\node[coordinate]                  (m305) {};          &
		\node[coordinate]                  (m306) {};          &
		\node[coordinate]                  (m307) {};          &
...
%	\draw[dspconn] (2.6,-2)--(m309);
	...
	\node [above of=m211,node distance=0.3cm,scale=0.9](o03){$X^{DFTG}_k(m)$};
	...
	\node [right of=m304,node distance=0.3cm,scale=0.9](n0){\small{$M$-1}};
	...
	\node [left of=m306,node distance=-0.2cm,scale=0.9](n0){\small{$M$-1}};
%	\node at(m204)[above,scale=0.64](o01){$W_M^{-k\rho}$};
%	\node at(m304)[above,scale=0.64](o01){$W_M^{-k(M-1)}$};

	\node at(3.2,1.8)[scale=0.9](m00){$W_M^{k_0mM}$};
	\draw[dspconn] (m00) -- (m009.south);
	\node at(3.2,0.4)[scale=0.9](m01){$W_M^{k_0mM}$};
	\draw[dspconn] (m01) -- (m109.south);
	\node at(3.2,-1.35)[scale=0.9](m02){$W_M^{k_0mM}$};
	\draw[dspconn] (m02) -- (m209.south);
	\node at(3.2,-3.05)[scale=0.9](m03){$W_M^{k_0mM}$};
	\draw[dspconn] (m03) -- (m309.south);
%	\draw[dspconn] (m105) -- (ad01);
%	\draw[dspconn] (m205) -- (ad01);
	\draw[dspconn] (-3.6,3) -- (-3.6,2);
