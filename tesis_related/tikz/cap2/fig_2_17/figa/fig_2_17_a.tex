...
%	\node at(m304)[above,scale=0.64](o01){$W_M^{-k(M-1)}$};
	...
	\node at(3.3,1.8)[scale=0.9](m00){$W_M^{k_0mM}$};
	\draw[dspconn] (m00) -- (m009.south);
	\node at(3.3,0.4)[scale=0.9](m01){$W_M^{k_0mM}$};
	\draw[dspconn] (m01) -- (m109.south);
	\node at(3.3,-1.35)[scale=0.9](m02){$W_M^{k_0mM}$};
	\draw[dspconn] (m02) -- (m209.south);
	\node at(3.3,-3.05)[scale=0.9](m03){$W_M^{k_0mM}$};
