...
\draw 
  ...
  node at (0,-2)[input, name=Qindac] {}
	...
	node at (2,0)[block,right of=lpf1i] (att1i) {Aten.}  
  node at (5.8,0.3)[]{$I$}
  %node at (4.8,-1)[]{Mezclador $IQ$}
  node [block, right of=Qindac] (lpf2i) {FPB}
	node at (0,-2)[block,right of=lpf2i] (att2i) {Aten.}
  ...
  node at (6.5,-1) [mixer] (mult1) {}
	node at (6.8,-1)[block,right of=mult1] (varatt1) {Aten. Var.}
  ...
  %node at (10,0.2)[]{Crióstato}
	...
	%{Detector\\criogénico}
  node at (4,-8)[buffer] (gain1) {}
  node [block,right of=gain1] (att3i) {FPB}
  node at (4,-8)[buffer, right of=att3i] (gain2) {}
  node at (6,-8)[mixer,right of=gain2] (mult2) {}
  node at (13,-6)[buffer] (gain3) {}
  node at (13,-10)[buffer] (gain4) {}
	node [block,right of=gain3] (att4) {Aten. var.}
  node [block,right of=gain4] (att5) {Aten. var.}
	node [block,right of=att4] (lpf6o) {FPB}
  node at (0,-2)[input, name=Qindac] {}
	node at (22,-6)[](Iadcout){Salida $I$ (al A/D) 0-200\,MHz,+10\,dBm}
  node [block,right of=att5] (lpf7o) {FPB}
	node at (22,-10)[](Qadcout){Salida $Q$ (al A/D) 0-200\,MHz,+10\,dBm}
