...
\begin{frame}{Estudio de la $T_c$}
				...
				\end{equation*}
								...
								\end{column}
				\begin{column}{0.49\textwidth}
								En películas de TiN se ha demostrado que la conductividad
								compleja $\sigma_2$, se desvía cada vez más de la teoría convencional
								de Mattis-Bardesn debido a un \alert{fuerte desorden de TiN}
								\end{column}
								\end{columns}
\end{frame}
\begin{frame}{Estudio de la $T_c$}
