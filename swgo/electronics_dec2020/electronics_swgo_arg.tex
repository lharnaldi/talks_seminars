				...
				\begin{block}{}
								\begin{itemize}
												...
												\item \alert{Formato de datos uniforme. Acorde a lo
													requerido en SWGO}
													\pause
												%\item Sistema adaptable a otros experimentos (siempre
												%	tenemos/queremos otros experimentos)
...
\begin{frame}
				...
				\begin{columns}
								\begin{column}{0.60\textwidth}
												\footnotesize{				\begin{block}{}
																\begin{itemize} %[<+->]
																				...
																				\item Se pueden conectar los sensores
																					que necesitemos. Buses/interfaces
																					estándar (I2C, SPI, UART) 
								...
								\begin{column}{0.4\textwidth}
												...
												\fbox{\includegraphics[width=0.95\textwidth]{caracteristicas_daq_rp}}
								\end{column}
				\end{columns}
\end{frame} 
...
\begin{frame}
				...
				\begin{columns}
								\begin{column}{0.50\textwidth}
												\fbox{\includegraphics[width=\textwidth]{base_antares}}\\
												\fbox{\includegraphics[width=0.6\textwidth]{fuente_DCDC}}
								\end{column} 
								\begin{column}{0.5\textwidth}
												\fbox{\includegraphics[width=0.9\textwidth]{placa_abajo}}
								\end{column}
