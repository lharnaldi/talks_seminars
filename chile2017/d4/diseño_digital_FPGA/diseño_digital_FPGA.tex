...
%recuadro como resaltándolo.
    ...
    \begin{column}{0.65\textwidth}
      \includegraphics[width=0.8\textwidth]{d3/adc_flash}
    \end{column}
  \end{columns}
\end{frame}
...
16 bits
          ...
          \item  Pequeño factor de forma %FIXME: explicar qué es el factor de
%forma
        \end{itemize}
      \end{block}
    \end{column} 
    \begin{column}{0.65\textwidth}
      \includegraphics[width=0.8\textwidth]{d3/adc_suc_app}
    \end{column}
  \end{columns}
\end{frame}
...
\frametitle{Las herramientas}
  \begin{columns}
    ...
    \end{column} 
    \begin{column}{0.65\textwidth}
      \includegraphics[width=0.8\textwidth]{d3/adc_v_to_f}
    \end{column}
  \end{columns}
\end{frame}
...
\frametitle{Las herramientas}
  \begin{columns}
    ...
    \end{column} 
    \begin{column}{0.65\textwidth}
      \includegraphics[width=0.8\textwidth]{d3/adc_dual_slope_curve}
    \end{column}
  \end{columns}
\end{frame}
...
\frametitle{Las herramientas}
  \begin{columns}
    ...
    \end{column} 
    \begin{column}{0.65\textwidth}
      %\includegraphics[width=0.8\textwidth]{d3/bloques_nexys2}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{}
    \centering
    %\includegraphics[height=0.75\textheight,width=0.75\textwidth]{d3/bloques_fpga_lago}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{}
    \centering
    %\includegraphics[height=0.75\textheight,width=0.75\textwidth]{d3/jerarquia_lago}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{El $\mu$C PicoBlaze}
    \centering
    %\includegraphics[height=0.60\textheight,width=0.85\textwidth]{d3/kcpsm3}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{En LAGO tenemos un Makefile que se ocupa de la mayoría de los
                ...
                FPGA.}
    \centering
    %\includegraphics[height=0.30\textheight,width=\textwidth]{d3/archivos_del_firmware}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{}
    \centering
    %\includegraphics[height=0.55\textheight,width=0.75\textwidth]{d3/shifting_baseline}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{}
    \centering
    %\includegraphics[height=0.55\textheight,width=0.75\textwidth]{d3/tres_chann2}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{}
    \centering
    %\includegraphics[height=0.55\textheight,width=0.75\textwidth]{d3/histogramas_por_canal_fija}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{}
    \centering
    %\includegraphics[height=0.55\textheight,width=0.75\textwidth]{d3/diagrama_en_bloques_lago}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{}
    \centering
    %\includegraphics[height=0.50\textheight,width=0.75\textwidth]{d3/front_end_circuit2}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{}
    \centering
    %\includegraphics[height=0.75\textheight,width=0.95\textwidth]{d3/shaper_lago}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{}
    \centering
    %\includegraphics[height=0.55\textheight,width=0.75\textwidth]{d3/baseline_vhd}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{}
    \centering
    %\includegraphics[height=0.60\textheight,width=0.75\textwidth]{d3/ma_filter_lago2}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{}
    \centering
    %\includegraphics[height=0.50\textheight,width=0.75\textwidth]{d3/resultado_ma_filter_ej}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{}
    \centering
    %\includegraphics[height=0.55\textheight,width=0.75\textwidth]{d3/histogramas_por_canal_normal}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{}
    \begin{center}
    %\includegraphics[width=\textwidth]{d3/histogramas_por_canal_fija}
    \end{center}
  \end{block}
	\end{column}
	\begin{column}{0.50\textwidth}
  \begin{block}{}
    \begin{center}
    %\includegraphics[width=\textwidth]{d3/histogramas_por_canal_normal}
    \end{center}
  \end{block}
	\end{column}
  \end{columns}
...
\begin{frame}
  ...
  \begin{block}{}
    \begin{center}
    %\includegraphics[height=0.55\textheight,width=0.98\textwidth]{d3/vista_sistema_lago_mx}
		\end{center}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{}
    \begin{center}
    %\includegraphics[height=0.75\textheight,width=0.75\textwidth]{d3/bloques_lago_mx}
		\end{center}
  \end{block}
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{}
    \begin{center}
    %\includegraphics[height=0.50\textheight,width=0.75\textwidth]{d3/configuracion_diferencial_lago_mx}
		\end{center}
  \end{block}
\end{frame}
...
\frametitle{Las herramientas}
  \begin{columns}
    ...
    \end{column} 
    \begin{column}{0.65\textwidth}
      \includegraphics[width=0.8\textwidth]{d3/adc_common_errors}
    \end{column}
  \end{columns}
\end{frame}
