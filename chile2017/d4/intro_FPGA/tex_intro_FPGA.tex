...
\title[Proyecto LAGO]{Introducción a la lógica programable}
...
\begin{block}{Compuertas lógicas}
	\includegraphics[width=\textwidth]{../media/basic_logic_gates.jpg}
\end{block}
\end{frame}
...
\begin{block}{Compuertas lógicas}
	\includegraphics[width=\textwidth]{../media/basic_secuential_elements_b.jpg}
\end{block}
\end{frame}
...
\end{block}
 ...
 \begin{column}{0.40\textwidth}
      \only<1>{\includegraphics[width=0.9\textwidth]{../media/PAL.jpg}}
      \only<2>{\includegraphics[width=0.8\textwidth]{../media/PLA.jpg}}
      \only<3>{\includegraphics[width=0.9\textwidth]{../media/cpld_estructura.jpg}}
 \end{column}
\end{columns}
\end{frame}
...
\end{block}
 \end{column} \ \
 \begin{column}{0.40\textwidth}
      \includegraphics[width=0.8\textwidth]{../media/estructura_de_un_cpld.jpg}
 \end{column}
\end{columns}
\end{frame}
...
\end{block}
 \end{column} \ \
 \begin{column}{0.40\textwidth}
      \only<1>{\includegraphics[width=0.8\textwidth]{../media/bloques_fpga.jpg}}
      \only<2-3>{\includegraphics[width=0.8\textwidth]{../media/sub_bloques_fpga.jpg}}
 \end{column}
\end{columns}
\end{frame}
...
\end{block}
 \end{column} \ \
 \begin{column}{0.40\textwidth}
      \only<1>{\includegraphics[width=0.8\textwidth]{../media/tipos_de_fpga1.jpg}}
      \only<2>{\includegraphics[width=0.8\textwidth]{../media/tipos_de_fpga2.jpg}}
      \only<3>{\includegraphics[width=0.8\textwidth]{../media/tipos_de_fpga3.jpg}}
      \only<4>{\includegraphics[width=0.8\textwidth]{../media/tipos_de_fpga4.jpg}}
 \end{column}
\end{columns}
\end{frame}
...
\begin{frame}
	...
	%\begin{block}{Ejemplo de una LUT}
      \includegraphics[width=0.95\textwidth]{../media/LUT_ej.jpg}
	%\end{block}
\end{frame}
...
\end{block}
 ...
 \begin{column}{0.60\textwidth}
      \includegraphics[width=0.8\textwidth]{../media/LUT_implementacion_funcion.jpg}
 \end{column}
\end{columns}
\end{frame}
