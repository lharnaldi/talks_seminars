	...
	\begin{columns}
		...
		\end{column} 
	 	\begin{column}{0.55\textwidth}
	  	\only<1-2>{\fbox{\includegraphics[width=\textwidth]{lago_daq}}}
	  	\only<3-4>{\fbox{\includegraphics[width=\textwidth]{placa_mx_2}}}
	 \end{column}
	\end{columns}
\end{frame} 
...
\begin{frame}
				\frametitle{Archivo de datos}
                        \begin{tikzpicture}
                                ...
                                \draw<1>[red,ultra thick,rounded corners]
																(0,4.4) rectangle (8.6,7.6);
                                \draw<2>[red,ultra thick,rounded corners] (0,1.8)
																rectangle (3.8,4.4);
                                \draw<3>[red,ultra thick,rounded corners] (0,0) rectangle (1,1.9);
                        \end{tikzpicture}
\end{frame}
